      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className={`items-center justify-between hidden w-full md:flex md:w-auto md:order-1`} id="navbar-sticky">
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <Link href="/">
                <p className="block py-2 pl-3 pr-4 text-gray-900 hover:text-primary rounded hover:bg-gray-100">Home</p>
              </Link>
            </li>
            <li>
              <Link href="/about">
                <p className="block py-2 pl-3 pr-4 text-gray-900 hover:text-primary rounded hover:bg-gray-100">About</p>
              </Link>
            </li>
            <li>
              <Link href="/blog">
                <p className="block py-2 pl-3 pr-4 text-gray-900 hover:text-primary rounded hover:bg-gray-100">Blog</p>
              </Link>
            </li>
            <li>
              <Link href="/map">
                <p className="block py-2 pl-3 pr-4 text-gray-900 hover:text-primary rounded hover:bg-gray-100">Map</p>
              </Link>
            </li>
            <li>
              <Link href="/contact">
                <p className="block py-2 pl-3 pr-4 text-gray-900 hover:text-primary rounded hover:bg-gray-100">Contact</p>
              </Link>
            </li>
          </ul>
        </div>
